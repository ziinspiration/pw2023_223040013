...
<head>
    ...
    <!-- Default CSS -->
    <link rel="stylesheet" href="../css/login-style/login-phone/before-login-phone.css" />
...
<body>
    ...
    <div class="container d-flex flex-column mt-5">
        <a href="../login-page/login-user.php" class="text-decoration-none">
            <div class="login d-flex bg-light mt-5 pt-3 pb-3 ps-4">
                <div class="text">
                    <h1>
                        <i class="fa-solid fa-user border-primary line-bord"></i> Masuk
                    </h1>
                </div>
            </div>
        </a>
        <!--  -->
        <a href="../login-page/register-user.php" class="text-decoration-none">
            <div class="register d-flex bg-light pt-3 pb-3 ps-4 mt-3">
                <div class="text">
                    <h1>
                        <i class="fa-solid fa-user-pen border-primary line-bord"></i>
                        Daftar
                    </h1>
                </div>
            </div>
