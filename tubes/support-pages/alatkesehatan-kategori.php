...
$kategori = "alatkesehatan"; // Mengganti $_GET["kategori"] dengan "promo"
...
<body>
    ...
    <div class="nama-kategori">
        <h5>Filter berdasarkan "Alat kesehatan"</h5>
    </div>
            ...
            <div class="card card-promo border border-2 border-primary rounded-5 ms-2 me-2" style="width: 18rem">
                ...
                <div class="card-body">
                    ...
                    <div class="card-text mt-4">
                        ...
                        <p class="price-promo text-primary">Rp.<?= $brg['harga_normal'] ?></p>
                    </div>
                    <!-- button -->
