...
<body>
    ...
    <div class="head d-flex bg-primary justify-content-between">
        <a class="ms-3 mt-2" href="riwayat-pembayaran.php"><i class="fa-solid fa-arrow-left"></i></a>
    ...
    <div class="container mt-5">
        ...
        <div class="pembeli text-secondary">
            ...
            <div class="bukti-transfer d d-flex flex-column">
                <p class="text-bold bukti me-1">Bukti pembayaran :</p>
                <img class="w-25 mt-2" src="assets/bukti-tf/<?= $brg['bukti_transfer']; ?>" alt="">
            </div>
        </div>
    </div>
