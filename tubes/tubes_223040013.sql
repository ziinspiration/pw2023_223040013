...
--
-- Host: localhost:3306
-- Waktu pembuatan: 01 Jun 2023 pada 12.02
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
CREATE TABLE `admind` (
  ...
  `id_admind` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
(1, 'Panadol biru tablet (1 strip)', 'HD-P-001', '64660d040ddcb.jpg', 'promo', 13.000, 11.000, 'Panadol biru bermanfaat untuk meredakan nyeri, seperti sakit kepala, sakit gigi, dan nyeri otot, serta menurunkan demam. Tiap kaplet Panadol Reguler mengandung 500 mg paracetamol.', 'Meringankan rasa sakit seperti sakit kepala, sakit gigi dan menurunkan demam.', 'Paracetamol 500g', 'Jangan mengonsumsi dan menggunakan paracetamol jika memiliki riwayat alergi dengan obat ini.', 'STERLING PRODUCTS INDONESIA', NULL),
(3, 'Kotak P3K Dinding', 'HD-P3K-001', '646614c9b50d7.png', 'p3k', 100.000, 100.000, 'KOTAK P3K DINDING merupakan kotak yang berisi obat-obatan dasar seperti obat merah, perban, obat pusing, dan ditujukan untuk di pasang di dinding rumah anda.', 'Membantu menangani keadaan darurat medis secepat mungkin.', 'Berisi obat-obatan dasar seperti obat merah, perban, obat pusing, dan ditujukan untuk di pasang di dinding rumah anda.', '-', '-', NULL),
(5, 'Omomed Masker Earloop', 'HD-ALKES-002', '64661645d60f1.jpg', 'alatkesehatan', 70.000, 70.000, 'OMOMED MASKER EARLOOP 50S merupakan masker sekali pakai dengan 3 lapisan filter untuk menahan bakteri.', 'Menahan partikel debu serta menyaring udara.', '1 Dos isi 50 Pcs', '-', '-', NULL),
...
INSERT INTO `user` (`user_id`, `username`, `password`, `nama_lengkap`, `email`, `no_handphone`, `alamat_lengkap`) VALUES
(1, 'ziimpossible', '$2y$10$q5H.TY/0vnJWQ.lNeCmsg.DJvohpm6byg7jWKqLRKo8V0IrfYL2Sq', 'Ilham ramadhana hartono', 'ilham@mail.unpas.ac.id', '085355064514', 'Gg.Hj ridho II, No 24E, Gegerkalong, Bandung'),
(6, 'diewehimpunan', '$2y$10$fLZvYBtOrrI6eQNt61tmxussw7b4IfQDpq1CfcXYCBpFA98CTBuFu', 'fakih helmi maulana', 'fakih.223040056@mail.unpas.ac.id', '085813753769', 'Gg.Hj ridho II, No 24E, Gegerkalong, Bandung'),
(7, 'lisvindanu', '$2y$10$3KUAaNsP0.NPleVGLHTwtOwCsT9JueCkAj/wTbyGvmI0gFIoq1CSm', 'Lisvindanu', 'Lisvindanu.223040038@mail.unpas.ac.id', '082254223714', 'Gg.Hj ridho II, No 24E, Gegerkalong, Bandung'),
(10, 'mgways88', '$2y$10$C.4eehIW6KI3atkSmWzsheUBWWcve43681SXO25fzwaC8Dq1A30Dm', 'Meutuah dicco linge', 'meutuah.223040098@mail.unpas.ac.id', '082211092793', 'Gg.Hj ridho II, No 24E, Gegerkalong, Bandung'),
(11, 'heryan00', '$2y$10$cMwESCiTcQEGRvuuuJfY5OeFAU4mP0lTYoi1jScQM5xGCI7h8GUnq', 'Heryani', '203040169@mail.unpas.ac.id', '0881081900348', 'Gg.Hj ridho II, No 24D, Gegerkalong, Bandung'),
(12, 'afat-cabul', '$2y$10$I4498JKKfSQe6FnwfIoIcuWNo9sK3dBQxy.ugeV07WuGejZoZ6zPG', 'muhammad alfath septian', 'alfath.223040014@mail.unpas.ac.id', '082254223714', 'Dipati ukur'),
(18, 'admind-halodek', '$2y$10$.ZeJt7Yt0dwGGfjJr1zIfeGuyhS1MlF5PTzsXmd68xrCSIZsCElXu', 'admind-halodek', 'admind-halodek@mail.unpas', 'admind-halodek', 'admind-halodek');
